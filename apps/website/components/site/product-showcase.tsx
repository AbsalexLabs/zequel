...
const SHOWCASE: ShowcaseItem[] = [
  ...
  },
  {
    ...
    title: 'Deep research, grounded in your sources',
    body: 'Switch into research mode to summarize, define key terms, and analyze documents at depth. Every response is backed by an evidence panel that lists the exact referenced sources and pages.',
    src: '/site/research-light.jpg',
    srcDark: '/site/research-dark.jpg',
    alt: 'Zequel research workspace showing document analysis with referenced evidence sources',
