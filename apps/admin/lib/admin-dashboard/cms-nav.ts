...
export const CMS_NAV: CmsNavItem[] = [
  ...
  { label: "Feature Pillars", href: "/cms/pillars", icon: "Columns3", group: "Content" },
  { label: "Stats", href: "/cms/stats", icon: "BarChart3", group: "Content" },
  { label: "How It Works", href: "/cms/steps", icon: "ListOrdered", group: "Content" },
  { label: "Testimonials", href: "/cms/testimonials", icon: "MessageSquareQuote", group: "Content" },
  { label: "Principles", href: "/cms/principles", icon: "Compass", group: "Content" },
  { label: "About Story", href: "/cms/about-story", icon: "BookText", group: "Content" },
